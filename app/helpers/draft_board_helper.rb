module DraftBoardHelper
  ...
  def chevron_down_icon(tailwind_color: "text-slate-700", tailwind_size: "size-5")
    content_tag(:svg, class: "#{tailwind_color} #{tailwind_size} transition-transform".strip, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", "data-slot": "icon", "aria-hidden": "true") do
